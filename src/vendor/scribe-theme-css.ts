// Auto-generated from scribe-theme.css
export const SCRIBE_THEME_CSS = `
/* Scribe PF2e theme CSS - extracted from scribe.pf2.tools rendered output */
/* Google Fonts imports are handled by the fonts() block at render time */
...
/* Page numbers are conditionally added by styles.ts when pagenumbers keyword is used */
